...
//        this.toggleRefreshButton(false);
    ...
    BootstrapTableFilter.prototype.removeFilter = function(field) {
        ...
        var f1 = field.replace('.', '\\.');
        this.$buttonList.find('[data-filter-field=' + f1 + ']').remove();
        this.trigger('remove-filter', f1);
    };
    ...
    BootstrapTableFilter.prototype.enableFilter = function(field) {
        ...
        var filter = this.getFilter(field);
        var $filterDropdown = $([
                '<div class="btn-group" data-filter-field="' + f1 + '">',
        ...
        this.$buttonList.find('[data-filter-field=' + f1 + '] input[type=checkbox]').prop('checked', true);
    ...
    BootstrapTableFilter.prototype.disableFilter = function(field) {
        ...
        var filter = this.getFilter(field);
        this.$buttonList.find('[data-filter-field=' + f1 + '] input[type=checkbox]').prop('checked', false);
        ...
        $.each(options, function(key, val) {
            if (key === '_values') {
                $.each(val, function(i, v) {
                    ...
                    $('div[data-filter-field="' + f1 + '"] [data-val="' + v + '"] input.filter-enabled').prop('checked', true);
                });
            }
            else {
                that.selectFilterOption(field, key, val);
                $('div[data-filter-field="' + f1 + '"] [data-val="' + key + '"] input.filter-enabled').prop('checked', true);
                $('div[data-filter-field="' + f1 + '"] [data-val="' + key + '"] input[type="text"]:not([data-name])').val(val);
            }
        });
    };
