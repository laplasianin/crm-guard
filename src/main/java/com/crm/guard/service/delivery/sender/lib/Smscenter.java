...
public class Smscenter {
    ...
    public Smscenter(String login, String password) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
    }

    public Smscenter(String login, String password, String charset) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
    }

    public Smscenter(String login, String password, String charset, boolean debug) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
        SMSC_DEBUG    = debug;
